...
<head>
    ...
    <?= $this->Html->css('wickedpicker/wickedpicker.min.css') ?>
    ...
    <?= $this->Html->script('wickedpicker/wickedpicker.min.js') ?>
...
<body class="">
   <?php echo $this->element('Menus/menu_top');?>
    <div class="page-content" style="height: 110%">
        <div class="flex-grid no-responsive-future" style="height: 100%;">
            <div class="row" style="height: 100%">
                <div class="cell size-x100" id="cell-sidebar" style="background-color: #71b1d1; height: 100%">

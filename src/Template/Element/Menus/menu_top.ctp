...
?>
        <div class="app-bar-element place-right">
	         <span class="app-bar-element branding"><?=OptionsUtil::getOption(OptionsUtil::COMPANY_NAME)->value1?> (ID: <?=str_pad(Configure::read('Account.active'), 3, 0, STR_PAD_LEFT)?>)</span>
	        <span class="app-bar-divider"></span>
            <span class="dropdown-toggle" style="padding-left: 20px;"><span class="mif-cog"></span> <?php echo $loggedUser['full_name'] ; ?></span>
            <div class="app-bar-drop-container padding10 place-right no-margin-top block-shadow fg-dark" data-role="dropdown" data-no-close="true" style="width: 220px">
                <h2 class="text-light"><?php echo $loggedUser['full_name'] ;?></h2>
                <h4><?php echo '(' . $authUser['roles'][0]['name'] . ')'?></h4>

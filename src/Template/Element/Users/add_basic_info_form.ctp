<?= $this->Form->create($user, ['type' => 'file', 'onSubmit'=>'return addBasicInfo()']) ?>
    <div class="grid" >
			    ...
			    <div id="password-container" style="display: none;">
			    	 <div class="cell">
				    	<label>Password</label>
				    	 <div class="input-control text full-size">
					        	 <input name="password" maxlength="255" id="password" type="text" value="">
					       </div>
				    </div>
				    <div class="cell">
				    	<label>Confirm Password</label>
				    	 <div class="input-control text full-size">
					        	 <input name="confirm-password" maxlength="255" id="confirm-password" type="text" value="">
					       </div>
				    </div>
			    </div>
			</div>

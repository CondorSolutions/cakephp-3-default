...
class LocationsUsersTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::exists('LocationsUsers') ? [] : ['className' => 'App\Model\Table\LocationsUsersTable'];
        $this->LocationsUsers = TableRegistry::get('LocationsUsers', $config);
    }

 ...
 *
 */
class DayOffsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'repeat_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'date' => '2016-04-26',
            'repeat_id' => 1,
            'created' => '2016-04-26 06:40:53',
            'created_by' => 1,
            'modified' => '2016-04-26 06:40:53',
            'modified_by' => 1
        ],
    ];
}

...
/**
 * StandardDayOffsFixture
 *
 */
class StandardDayOffsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'day_off_type' => ['type' => 'string', 'length' => 50, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'day_off_type' => 'Lorem ipsum dolor sit amet',
            'day' => 1,
            'date' => '2016-04-21',
            'created' => '2016-04-21 08:56:09',
            'created_by' => 1,
            'modified' => '2016-04-21 08:56:09',
            'modified_by' => 1
        ],
    ];
}
